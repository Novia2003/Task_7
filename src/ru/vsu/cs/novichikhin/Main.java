...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (result.getTestResult()) {
            printResultTest(result.getTestResult());
    ...
    private static void printResultTest(boolean result) {
        if (result) {
            System.out.println("Тестирование завершено. Программа работает исправно.");
        } else {
            System.out.println("Тестирование провалено. Программа работает неправильно.");
        }
    }
